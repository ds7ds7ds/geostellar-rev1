...
const HomePage = () => {
  const capabilities = [
    ...
    },
    {
      ...
      description: 'Rigorous testing protocols inherited from oil and gas industry standards'
    },
    {
  ...
  return (
    <div className="pt-16">
      <section className="relative flex min-h-[calc(100svh-4rem)] items-start lg:items-center overflow-hidden grid-pattern">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-900 to-sky-900/20" />

        <div className="absolute top-1/4 right-1/4 hidden sm:block w-64 h-64 bg-sky-500/10 rounded-full blur-3xl animate-pulse-glow" />
        <div className="absolute bottom-1/4 left-1/4 hidden sm:block w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl animate-pulse-glow animation-delay-400" />
        <div className="absolute top-1/3 right-1/3 hidden lg:block w-32 h-32 bg-sky-400/5 rounded-full blur-2xl animate-float" />
        <div className="absolute bottom-1/3 right-1/4 hidden lg:block w-48 h-48 bg-cyan-400/5 rounded-full blur-2xl animate-float-slow" />

        <div className="absolute top-20 right-20 hidden lg:block w-4 h-4 bg-sky-500/30 rotate-45 animate-float" />
        <div className="absolute top-40 right-40 hidden lg:block w-2 h-2 bg-cyan-400/40 rounded-full animate-float-slow" />
        <div className="absolute bottom-40 left-20 hidden lg:block w-3 h-3 bg-sky-400/20 rotate-45 animate-float animation-delay-200" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-24 sm:pt-20 sm:pb-28 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-400 text-xs sm:text-sm mb-5 sm:mb-6 animate-slide-up">
                <span className="w-2 h-2 bg-sky-400 rounded-full mr-2 animate-pulse" />
                Geothermal Engineering Excellence
              </div>

              <h1 className="text-[clamp(2.8rem,9vw,5.5rem)] font-light text-white leading-[0.96] tracking-tight mb-5 sm:mb-6 animate-slide-up animation-delay-200">
                Maximum BTU
                <span className="block text-[clamp(2rem,7vw,4.25rem)] text-slate-300">per square foot.</span>
                <span className="block gradient-text font-semibold">Minimum Lifetime Cost.</span>
              </h1>

              <p className="max-w-xl text-base sm:text-lg lg:text-xl text-slate-400 leading-relaxed mb-4 animate-slide-up animation-delay-400">
                We bring <span className="text-sky-400 font-semibold">oil and gas precision</span> to geothermal,
                not to be expensive, but to make clean energy <span className="text-white">accessible for everyone</span>.
              </p>

              <p className="max-w-lg text-base sm:text-lg text-slate-500 leading-relaxed mb-8 animate-slide-up animation-delay-600">
                <em>Thermal density optimized through geometry, hydraulics, and verified field performance.</em>
              </p>

              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-slide-up animation-delay-800">
                <Link
                  to="/services"
                  className="group inline-flex min-h-12 items-center justify-center px-6 py-3 bg-sky-500 hover:bg-sky-400 text-slate-900 font-medium rounded transition-all hover:shadow-lg hover:shadow-sky-500/25"
                >
                  Explore Services
                ...
                <Link
                  to="/about"
                  className="inline-flex min-h-12 items-center justify-center px-6 py-3 border border-slate-600 hover:border-sky-500 text-white rounded transition-colors"
                >
                  Meet the Team
                </Link>
              </div>
        ...
        <div className="absolute bottom-8 left-1/2 hidden md:flex -translate-x-1/2 flex-col items-center text-slate-500 animate-fade-in animation-delay-800">
            ...
            <div className="space-y-6">
              <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-lg">
                ...
                <ul className="space-y-2">
                  {[
                    'Maximizing BTU per square foot of available surface area',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-white mb-4">
              Lowest Cost Is Not The Lowest Bid
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-400 leading-relaxed mb-6">
                We maximize BTU per square foot by engineering every controllable variable:
              </p>
